[![Build](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/build.yml) [![Test](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/test.yml) [![Coverage](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/coverage.yml/badge.svg?branch=main)](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/coverage.yml) [![CodeQL Advanced](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/codeql.yml/badge.svg?branch=main)](https://github.com/iabhishekrajput/anekdote-auth/actions/workflows/codeql.yml)
